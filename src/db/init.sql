...
-- banned_wordsテーブル作成(テーブル大文字)
CREATE TABLE IF NOT EXISTS BANNED_WORDS (
  id VARCHAR(36) NOT NULL,
  banned_word VARCHAR(255) NOT NULL UNIQUE,
  replace_text VARCHAR(255) NOT NULL,
  match_type VARCHAR(20) NOT NULL DEFAULT 'strict',
  is_active BOOLEAN NOT NULL DEFAULT TRUE,
  PRIMARY KEY (id)
);

-- safety_wordsテーブル作成(テーブル大文字)
CREATE TABLE IF NOT EXISTS SAFETY_WORDS (
  id VARCHAR(36) NOT NULL,
  safety_word VARCHAR(255) NOT NULL UNIQUE,
  PRIMARY KEY (id)
);
